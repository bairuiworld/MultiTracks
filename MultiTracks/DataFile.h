...
public:
	...
	t_Str		GetValue(t_Str szKey, t_Str szSection = t_Str(""), t_Str def = ""); 
				// GetString: Returns the value as a t_Str
	t_Str		GetString(t_Str szKey, t_Str szSection = t_Str(""), t_Str def = ""); 
				// GetFloat: Return the value as a float
	float		GetFloat(t_Str szKey, t_Str szSection = t_Str(""), float def = FLT_MIN);
				// GetInt: Return the value as an int
	int			GetInt(t_Str szKey, t_Str szSection = t_Str(""), int def = INT_MIN);
				// GetBool: Return the value as a bool
	bool		GetBool(t_Str szKey, t_Str szSection = t_Str(""), bool def = false);
